        ...
        <div class="cart-container">
          ...
          >
            ...
            <v-flex class="product_title" xs3 sm1 md1 lg1>
              <div @click="reviewProduct(index)" class="">
                {{ product.product.title }}
              </div>
            </v-flex>
            <v-flex xs3 sm3 md3 lg3 class="desc">
              <div v-html="product.product.description">
            ...
            <v-flex xs3 sm1 md1 lg1>
              <div class="center">
                ...
                {{ product.quantity }}
                <i
                  @click="product.quantity ? decreaseQuantity(index) : null"
                  class="material-icons pointer"
                  >remove</i
                >
              </div>
          ...
          >
            <div class="modal-content grey darken-2">
                ...
                <form class="col s12">
                  ...
                  <div class="row">
                    <div class="input-field col s12">
                      ...
                      />
                      <label id="foreignAddress" for="foreignAddress"
              ...
              <div>
                ...
                <v-btn @click="submitOrder" color="primary"
                  >Submit Order
                </v-btn>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    reviewProduct(index) {
      ...
      this.$router.history.push(`/product/${product.title}`);
    },
    async fillCart(id) {
      this.$store.dispatch('setCart')
      this.cart = this.$store.state.cart.map(cv => {
        return {
          product: cv.product,
...
If you are having trouble completing an order, Please contact us at DogCompanyDtx@gmail.com`
      ...
      this.$store.commit('completeOrder', order);
  ...
  computed: {
    orderTotal() {
      ...
      if (this.discountCode.match(/prb/gi)) {
        this.discountAmount = actualTotal * 0.2;
        return actualTotal * 0.8;
      } else {
