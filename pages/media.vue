<template>
  ...
  >
    ...
    >
      <div class="container">
        <div :key="i" v-for="(al, i) in albums">
          <div class="row">
            ...
            <div class="col s12 m7 l7 album-container">
              <p>
                <span
                  style="font-size: 3em; font-family: Lobster,cursive,Georgia;"
                >
                  {{ al.album_info.title }}
                </span>
                <br />
                <span>
                  ...
                  <a target="_blank" :href="al.album_info.label_link">{{
                    al.album_info.record_label
                  }}</a>
                </span>
              </p>
              <ol>
                ...
                >
                  <a v-if="song.song_url" target="_blank" :href="song.song_url">
                    {{ song.song_title }}
...
export default {
  ...
  mixins: [scroll],
  async mounted() {
    Object.assign(this, { albums: this.$store.state.media });
  },
  data() {
    return {
      albums: []
